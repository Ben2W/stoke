      ...
      <div className="border-b border-zinc-200 bg-white px-5 py-5 sm:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-4 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <code className="w-fit rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 text-xs text-zinc-600">stoke use {project.slug}</code>
          </div>
        </div>
      </div>

      <div className="mx-auto max-w-7xl px-5 py-6 sm:px-8 sm:py-8">
        <ProjectWorkspaces checkouts={checkouts} project={project} />
