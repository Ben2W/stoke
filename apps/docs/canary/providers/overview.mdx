...
- [Freestyle provider](/canary/providers/freestyle) covers VM, snapshot, SSH, cmux,
  and VS Code helpers.
- [Terminal provider](/canary/providers/terminal) covers browser terminal sessions.
- [cmux provider](/canary/providers/cmux) covers local cmux integration.
- [gcloud provider](/canary/providers/gcloud) covers copying local Google Cloud CLI
  state into workspaces.
- [Provider storage](/canary/providers/storage) covers storage boundaries and secrets.
- [Creating providers](/canary/providers/creating-providers) covers custom provider
  packages.
