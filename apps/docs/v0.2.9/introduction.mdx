...
Start with [Quickstart](/v0.2.9/guides/quickstart) if you want a working project.
Read [Concepts](/v0.2.9/concepts/mental-model) when you want the mental model behind
tasks, context, providers, caches, and workspaces.

When you are ready to write real project configs, use:

- [Workflows](/v0.2.9/guides/workflows) for `workflow`, `sequence`, `.task`,
  `.parallel`, `.configure`, and output validation.
- [Workspaces and operations](/v0.2.9/guides/workspaces) for `rig create`,
  `rig run`, lifecycle hooks, and operation inputs.
- [Providers](/v0.2.9/providers/overview) for Freestyle, terminal sessions, cmux,
  gcloud, custom providers, and provider storage boundaries.
- [Advanced fragments](/v0.2.9/advanced/fragments) for reusable global bases and
  wrapper fragments.
- [Creating providers](/v0.2.9/providers/creating-providers) for building your own
  provider package.
