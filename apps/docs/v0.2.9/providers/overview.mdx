...
- [Freestyle provider](/v0.2.9/providers/freestyle) covers VM, snapshot, SSH, cmux,
  and VS Code helpers.
- [Terminal provider](/v0.2.9/providers/terminal) covers browser terminal sessions.
- [cmux provider](/v0.2.9/providers/cmux) covers local cmux integration.
- [gcloud provider](/v0.2.9/providers/gcloud) covers copying local Google Cloud CLI
  state into workspaces.
- [Provider storage](/v0.2.9/providers/storage) covers storage boundaries and secrets.
- [Creating providers](/v0.2.9/providers/creating-providers) covers custom provider
  packages.
