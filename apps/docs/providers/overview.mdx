...
| --- | --- | --- |
| [Freestyle](/providers/freestyle) | `@rigkit/provider-freestyle` | VMs, snapshots, SSH options, VS Code URLs, and Freestyle SDK access. |
| [Terminal](/providers/terminal) | `@rigkit/provider-freestyle` | Provider-owned browser terminal sessions for interactive setup or SSH. |
| [cmux](/providers/cmux) | `@rigkit/provider-cmux` | Opening local cmux workspaces with remote SSH sessions and preview URLs. |
| [gcloud](/providers/gcloud) | `@rigkit/provider-gcloud-cli` | Copying local `gcloud` auth/config files into a workspace. |

Need something else? See [Creating providers](/providers/creating-providers)
...
[Cache and state](/concepts/cache-and-state).

## Next pages

- [Freestyle provider](/providers/freestyle) covers VM, snapshot, SSH, cmux,
  and VS Code helpers.
- [Terminal provider](/providers/terminal) covers browser terminal sessions.
- [cmux provider](/providers/cmux) covers local cmux integration.
- [gcloud provider](/providers/gcloud) covers copying local Google Cloud CLI
  state into workspaces.
- [Creating providers](/providers/creating-providers) covers custom provider
  packages.
