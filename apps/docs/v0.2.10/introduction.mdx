...
once in a `rigkit/index.ts` file, and then spin up as many isolated workspaces
...
<Tip>
  **New here?** Jump straight to the [Quickstart](/v0.2.10/guides/quickstart) to get a
  working environment in a few commands. The [CLI reference](/v0.2.10/reference/cli)
...
- **You run the `rig` CLI.** Most users. Start with the
  [Quickstart](/v0.2.10/guides/quickstart), then keep the
  [CLI reference](/v0.2.10/reference/cli) handy. Skim
  [Concepts](/v0.2.10/concepts/mental-model) when something behaves unexpectedly.
- **You write `rigkit/index.ts` for your team.** Read
  [Concepts](/v0.2.10/concepts/mental-model) first, then
  [Workflows](/v0.2.10/guides/workflows), [Workspaces and operations](/v0.2.10/guides/workspaces),
  and [Fragments](/v0.2.10/advanced/fragments). The
  [built-in providers](/v0.2.10/providers/overview) section tells you what's available.
- **You're building a custom provider.** See
  [Creating providers](/v0.2.10/providers/creating-providers).
...
For a sense of what a `rigkit/index.ts` looks like, here's a complete website
