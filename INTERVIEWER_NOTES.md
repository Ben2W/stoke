...
| Component                                                               | Purpose                                                                                                                                                                                                   |
| ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`apps/app`](./apps/app)                                                | The Vercel-hosted control plane, Hono API, Better Auth integration, Drizzle/Postgres data layer, API-driven run event transport, persistent Sandbox evaluator, dashboard, cache DAG, workspace UI, and web terminal. |
