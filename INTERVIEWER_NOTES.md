...
| Component                                                               | Purpose                                                                                                                                                                                                   |
| ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`apps/app`](./apps/app)                                                | The Vercel-hosted control plane, Hono API, Better Auth integration, Drizzle/Postgres data layer, authoritative HTTP run transport with Postgres-backed WebSocket invalidation, persistent Sandbox evaluator, dashboard, cache DAG, workspace UI, and web terminal. |
